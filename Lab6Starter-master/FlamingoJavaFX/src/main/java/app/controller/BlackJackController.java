...
public class BlackJackController implements Initializable {
	...
	public void btnHit_Click(ActionEvent event) {
		...
		patTMoveRot.getChildren().addAll(scaleT, pathT);
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new ArcTo( 10, 10, 10, toPoint.getX(), toPoint.getY()/3, true, true));
		path.getElements().add(new ArcTo( 10, 10, 10, toPoint.getX(), toPoint.getY()*2/3, true, false));
		path.getElements().add(new ArcTo( 10, 10, 10, toPoint.getX(), toPoint.getY(), true, true));
